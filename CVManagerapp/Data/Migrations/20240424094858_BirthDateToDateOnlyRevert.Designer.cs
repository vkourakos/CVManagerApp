...
namespace CVManagerapp.Data.Migrations
{
    ...
    [Migration("20240424094858_BirthDateToDateOnlyRevert")]
    partial class BirthDateToDateOnlyRevert
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CVManagerapp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CVManagerapp.Models.CV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVManagerapp.Models.CV", b =>
                {
                    b.HasOne("CVManagerapp.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CVManagerapp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
